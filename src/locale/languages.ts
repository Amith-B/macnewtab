const enTranslation = {
    ...
    freeform_pricing_notice: "✨ Freeform is free for now — some features may move to a paid plan in the future. Support us to help keep it free for everyone!",
    ...
    support_description: "Mac New Tab is free and always will be. If you enjoy using it, a small coffee goes a long way in keeping updates and new features alive!",
    spaces: "Spaces",
    spaces_description: "Create separate workspaces with their own wallpaper, theme, todos, and notes",
    spaces_enable: "Enable Spaces",
    spaces_add: "Add Space",
    spaces_name_placeholder: "Space name",
    spaces_delete: "Delete Space",
    spaces_delete_confirm: "Delete this space? All its settings, todos, and notes will be permanently removed.",
    spaces_cannot_delete_last: "Cannot delete the last space",
    spaces_time_sensitive: "Time-Sensitive Spaces",
    spaces_time_sensitive_description: "Automatically switch spaces based on time of day",
...
export const translation: Record<string, Record<string, string>> & { en: typeof enTranslation } = {
  ...
  kn: {
    ...
    freeform_pricing_notice: "✨ Freeform ಈಗ ಉಚಿತ — ಭವಿಷ್ಯದಲ್ಲಿ ಕೆಲವು ವೈಶಿಷ್ಟ್ಯಗಳು ಪಾವತಿ ಯೋಜನೆಗೆ ಸೇರಬಹುದು. ಎಲ್ಲರಿಗೂ ಉಚಿತವಾಗಿ ಉಳಿಸಲು ಸಹಾಯ ಮಾಡಿ!",
    ...
    support_description: "ಮ್ಯಾಕ್ ನ್ಯೂ ಟ್ಯಾಬ್ ಉಚಿತವಾಗಿದೆ ಮತ್ತು ಯಾವಾಗಲೂ ಇರಲಿದೆ. ನಿಮಗೆ ಇದು ಇಷ್ಟವಾದರೆ, ಒಂದು ಚಿಕ್ಕ ಕಾಫಿ ಕೊಡಿಸುವ ಮೂಲಕ ಬೆಂಬಲಿಸಿದರೆ ಮುಂದಿನ ಅಪ್‌ಡೇಟ್‌ಗಳು ಹಾಗೂ ಹೊಸ ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ತರಲು ತುಂಬಾ ಸಹಾಯವಾಗುತ್ತದೆ!",
    spaces: "ಸ್ಪೇಸ್ ಗಳು",
    spaces_description: "ತಮ್ಮದೇ ಆದ ವಾಲ್‌ಪೇಪರ್, ಥೀಮ್, ಟೊಡೊಗಳು ಮತ್ತು ಟಿಪ್ಪಣಿಗಳೊಂದಿಗೆ ಪ್ರತ್ಯೇಕ ಕಾರ್ಯಕ್ಷೇತ್ರಗಳನ್ನು ರಚಿಸಿ",
    ...
    spaces_delete_confirm: "ಈ ಸ್ಪೇಸ್ ಅನ್ನು ಅಳಿಸಬೇಕೆ? ಅದರ ಎಲ್ಲಾ ಸೆಟ್ಟಿಂಗ್‌ಗಳು, ಟೊಡೊಗಳು ಮತ್ತು ಟಿಪ್ಪಣಿಗಳನ್ನು ಶಾಶ್ವತವಾಗಿ ತೆಗೆದುಹಾಕಲಾಗುತ್ತದೆ.",
    spaces_cannot_delete_last: "ಕೊನೆಯ ಸ್ಪೇಸ್ ಅನ್ನು ಅಳಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ",
    spaces_time_sensitive: "ಸಮಯ-ಸೂಕ್ಷ್ಮ ಸ್ಪೇಸ್ ಗಳು",
    spaces_time_sensitive_description: "ದಿನದ ಸಮಯವನ್ನು ಆಧರಿಸಿ ಸ್ಪೇಸ್ ಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಬದಲಾಯಿಸಿ",
    spaces_time_range: "ಸಕ್ರಿಯ ಸಮಯ",
    spaces_time_overlap_error: "ಸಮಯದ ಶ್ರೇಣಿಗಳು ಇತರ ಸ್ಪೇಸ್ ಗಳೊಂದಿಗೆ ಅತಿಕ್ರಮಿಸುವಂತಿಲ್ಲ",
  ...
  cs: {
    ...
    freeform_pricing_notice: "✨ Freeform je nyní zdarma — některé funkce mohou být v budoucnu zpoplatněny. Pomozte nám to udržet zdarma!",
    ...
    support_description: "Mac New Tab je zdarma a vždy bude. Pokud ho rádi používáte, koupí malé kávy velmi podpoříte budoucí aktualizace a vývoj nových funkcí!",
    spaces: "Prostory",
    spaces_description: "Vytvořte si oddělené pracovní prostory s vlastní tapetou, motivem, úkoly a poznámkami",
    ...
    spaces_delete_confirm: "Smazat tento prostor? Všechna jeho nastavení, úkoly a poznámky budou trvale odstraněny.",
    spaces_cannot_delete_last: "Nelze smazat poslední prostor",
    spaces_time_sensitive: "Časově citlivé prostory",
    spaces_time_sensitive_description: "Automaticky přepínat prostory podle denní doby",
    spaces_time_range: "Aktivní čas",
    spaces_time_overlap_error: "Časové rozsahy se nesmí překrývat s jinými prostory",
  ...
  tr: {
    ...
    freeform_pricing_notice: "✨ Freeform şu an ücretsiz — bazı özellikler gelecekte ücretli olabilir. Ücretsiz kalmasına yardım edin!",
    ...
    support_description: "Mac New Tab ücretsizdir ve her zaman öyle kalacaktır. Kullanmaktan keyif alıyorsanız, küçük bir kahve ısmarlamak gelecekteki güncellemeleri ve yeni özellikleri desteklemeye çok yardımcı olur!",
    spaces: "Alanlar",
    spaces_description: "Kendi duvar kağıdı, teması, yapılacaklar listesi ve notları olan ayrı çalışma alanları oluşturun",
    spaces_enable: "Alanları Etkinleştir",
    spaces_add: "Alan Ekle",
    spaces_name_placeholder: "Alan adı",
    spaces_delete: "Alanı Sil",
    spaces_delete_confirm: "Bu alan silinsin mi? Tüm ayarları, yapılacaklar listesi ve notları kalıcı olarak kaldırılacaktır.",
    spaces_cannot_delete_last: "Son alan silinemez",
    spaces_time_sensitive: "Zamana Duyarlı Alanlar",
    spaces_time_sensitive_description: "Alanları günün saatine göre otomatik olarak değiştir",
  ...
  vi: {
    ...
    freeform_pricing_notice: "✨ Freeform hiện miễn phí — một số tính năng có thể trả phí trong tương lai. Hãy ủng hộ để giữ miễn phí!",
    ...
    support_description: "Mac New Tab miễn phí và sẽ luôn như vậy. Nếu bạn thích, việc mời một ly cà phê nhỏ sẽ giúp ích rất nhiều cho việc hỗ trợ các bản cập nhật và tính năng mới trong tương lai!",
    spaces: "Không gian",
    spaces_description: "Tạo các không gian làm việc riêng biệt với hình nền, chủ đề, công việc và ghi chú riêng",
    spaces_enable: "Bật Không gian",
    spaces_add: "Thêm Không gian",
    spaces_name_placeholder: "Tên không gian",
    spaces_delete: "Xóa Không gian",
    spaces_delete_confirm: "Xóa không gian này? Tất cả các cài đặt, công việc và ghi chú của nó sẽ bị xóa vĩnh viễn.",
    spaces_cannot_delete_last: "Không thể xóa không gian cuối cùng",
    spaces_time_sensitive: "Không gian theo thời gian",
    spaces_time_sensitive_description: "Tự động chuyển đổi không gian dựa trên thời gian trong ngày",
    spaces_time_range: "Thời gian hoạt động",
    spaces_time_overlap_error: "Khoảng thời gian không thể trùng lặp với các không gian khác",
  ...
  uz: {
    ...
    freeform_pricing_notice: "✨ Freeform hozir bepul — kelajakda ba'zi funksiyalar pullik bo'lishi mumkin. Bepul saqlab qolishga yordam bering!",
    ...
    support_description: "Mac New Tab bepul va har doim shunday bo'ladi. Agar u sizga yoqsa, kichik bir qahva bilan siylash kelajakdagi yangilanishlar va yangi xususiyatlarni qo'llab-quvvatlashga juda katta yordam beradi!",
    spaces: "Bo'shliqlar",
    spaces_description: "O'zining fon rasmi, mavzusi, vazifalari va eslatmalariga ega bo'lgan alohida ish bo'shliqlarini yarating",
    ...
    spaces_delete_confirm: "Ushbu bo'shliq o'chirilsinmi? Uning barcha sozlamalari, vazifalari va eslatmalari butunlay olib tashlanadi.",
    spaces_cannot_delete_last: "Oxirgi bo'shliqni o'chirib bo'lmaydi",
    spaces_time_sensitive: "Vaqtga sezgir bo'shliqlar",
    spaces_time_sensitive_description: "Kunning vaqtiga qarab bo'shliqlarni avtomatik ravishda almashtirish",
    spaces_time_range: "Faol vaqt",
    spaces_time_overlap_error: "Vaqt oralig'i boshqa bo'shliqlar bilan mos kelmasligi kerak",
  ...
  zh: {
    ...
    freeform_pricing_notice: "✨ Freeform 目前免费 — 未来某些功能可能会收费。请支持我们让它保持免费！",
    ...
    animation_type: "动画类型",
    support_description: "Mac New Tab 会一直免费。如果您喜欢使用它，请我喝杯咖啡将极大地帮助支持未来的更新和新功能！",
    spaces: "空间",
    ...
    spaces_delete: "删除空间",
    spaces_delete_confirm: "确定删除此空间吗？其所有设置、待办事项和笔记将被永久移除。",
  ...
  hi: {
    ...
    freeform_pricing_notice: "✨ Freeform अभी मुफ़्त है — भविष्य में कुछ सुविधाएं सशुल्क हो सकती हैं। इसे सभी के लिए मुफ़्त रखने में मदद करें!",
    ...
    support_description: "मैक न्यू टैब हमेशा मुफ़्त रहेगा। अगर आपको यह पसंद है, तो एक छोटी सी कॉफ़ी पिलाकर आप भविष्य के अपडेट और नए फ़ीचर्स लाने में हमारी बहुत मदद कर सकते हैं!",
    spaces: "स्पेस",
    spaces_description: "अपने वॉलपेपर, थीम, टू-डू और नोट्स के साथ अलग-अलग कार्यक्षेत्र बनाएं",
    spaces_enable: "स्पेस सक्षम करें",
    spaces_add: "स्पेस जोड़ें",
    spaces_name_placeholder: "स्पेस का नाम",
    spaces_delete: "स्पेस हटाएं",
    spaces_delete_confirm: "क्या आप इस स्पेस को हटाना चाहते हैं? इसकी सभी सेटिंग्स, टू-डू और नोट्स स्थायी रूप से हटा दिए जाएंगे।",
    spaces_cannot_delete_last: "अंतिम स्पेस को नहीं हटाया जा सकता",
    spaces_time_sensitive: "समय-संवेदनशील स्पेस",
    spaces_time_sensitive_description: "दिन के समय के आधार पर स्वचालित रूप से स्पेस स्विच करें",
  ...
  it: {
    ...
    freeform_pricing_notice: "✨ Freeform è gratuito per ora — alcune funzioni potrebbero diventare a pagamento. Supportaci per mantenerlo gratuito!",
    ...
    support_description: "Mac New Tab è gratuito e lo sarà sempre. Se ti piace, offrirmi un caffè è un grande aiuto per supportare i futuri aggiornamenti e le nuove funzionalità!",
    spaces: "Spazi",
    spaces_description: "Crea spazi di lavoro separati con sfondi, temi, attività e note personalizzati",
    ...
    spaces_delete_confirm: "Eliminare questo spazio? Tutte le sue impostazioni, attività e note verranno rimosse in modo permanente.",
    spaces_cannot_delete_last: "Impossibile eliminare l'ultimo spazio",
    spaces_time_sensitive: "Spazi sensibili al tempo",
    spaces_time_sensitive_description: "Passa automaticamente da uno spazio all'altro in base all'ora del giorno",
    spaces_time_range: "Tempo Attivo",
    spaces_time_overlap_error: "Gli intervalli di tempo non possono sovrapporsi ad altri spazi",
  ...
  bn: {
    ...
    freeform_pricing_notice: "✨ Freeform এখন বিনামূল্যে — ভবিষ্যতে কিছু বৈশিষ্ট্য সশুল্ক হতে পারে। সবার জন্য বিনামূল্যে রাখতে সাহায্য করুন!",
    ...
    support_description: "ম্যাক নিউ ট্যাব বিনামূল্যে আছে এবং সর্বদা থাকবে। আপনি যদি এটি ব্যবহার করতে পছন্দ করেন, তবে একটি ছোট কফি উপহার দিলে এটি ভবিষ্যতের আপডেট এবং নতুন বৈশিষ্ট্যগুলি আনতে অনেক সাহায্য করবে!",
    spaces: "স্পেস",
    spaces_description: "নিজস্ব ওয়ালপেপার, থিম, করণীয় এবং নোট সহ পৃথক ওয়ার্কস্পেস তৈরি করুন",
    spaces_enable: "স্পেস সক্ষম করুন",
    spaces_add: "স্পেস যোগ করুন",
    spaces_name_placeholder: "স্পেসের নাম",
    spaces_delete: "স্পেস মুছুন",
    spaces_delete_confirm: "এই স্পেসটি কি মুছে ফেলবেন? এর সমস্ত সেটিংস, করণীয় এবং নোট স্থায়ীভাবে মুছে ফেলা হবে।",
    spaces_cannot_delete_last: "শেষ স্পেসটি মুছে ফেলা যাবে না",
    spaces_time_sensitive: "সময়-সংবেদনশীল স্পেস",
    spaces_time_sensitive_description: "দিনের সময়ের উপর ভিত্তি করে স্বয়ংক্রিয়ভাবে স্পেস পরিবর্তন করুন",
    spaces_time_range: "সক্রিয় সময়",
    spaces_time_overlap_error: "সময়ের ব্যাপ্তি অন্যান্য স্পেসের সাথে মিলে যেতে পারে না",
  ...
  pt: {
    ...
    freeform_pricing_notice: "✨ Freeform é gratuito por enquanto — alguns recursos podem se tornar pagos no futuro. Apoie-nos para mantê-lo gratuito!",
    ...
    support_description: "O Mac New Tab é gratuito e sempre será. Se você gosta de usá-lo, pagar um cafezinho ajuda muito a apoiar futuras atualizações e novos recursos!",
    spaces: "Espaços",
    spaces_description: "Crie espaços de trabalho separados com seu próprio papel de parede, tema, tarefas e notas",
    ...
    spaces_delete_confirm: "Excluir este espaço? Todas as suas configurações, tarefas e notas serão removidas permanentemente.",
    spaces_cannot_delete_last: "Não é possível excluir o último espaço",
    spaces_time_sensitive: "Espaços Sensíveis ao Tempo",
    spaces_time_sensitive_description: "Alterne automaticamente os espaços com base na hora do dia",
    spaces_time_range: "Tempo Ativo",
    spaces_time_overlap_error: "Os intervalos de tempo não podem se sobrepor a outros espaços",
  ...
  fr: {
    ...
    freeform_pricing_notice: "✨ Freeform est gratuit pour l'instant — certaines fonctionnalités pourraient devenir payantes. Aidez-nous à le garder gratuit !",
    ...
    support_description: "Mac New Tab est gratuit et le restera toujours. Si vous l'appréciez, m'offrir un petit café m'aidera énormément à développer de futures mises à jour et de nouvelles fonctionnalités !",
    spaces: "Espaces",
    spaces_description: "Créez des espaces de travail séparés avec leur propre fond d'écran, thème, tâches et notes",
    ...
    spaces_delete_confirm: "Supprimer cet espace ? Tous ses paramètres, tâches et notes seront définitivement supprimés.",
    spaces_cannot_delete_last: "Impossible de supprimer le dernier espace",
    spaces_time_sensitive: "Espaces sensibles au temps",
    spaces_time_sensitive_description: "Changez automatiquement d'espace en fonction de l'heure de la journée",
    spaces_time_range: "Temps Actif",
    spaces_time_overlap_error: "Les plages horaires ne peuvent pas chevaucher d'autres espaces",
  ...
  ru: {
    ...
    freeform_pricing_notice: "✨ Freeform сейчас бесплатен — некоторые функции могут стать платными. Поддержите нас, чтобы он остался бесплатным!",
    ...
    support_description: "Mac New Tab бесплатен и всегда будет таким. Если он вам нравится, небольшая сумма на чашечку кофе очень поможет в разработке новых функций и будущих обновлений!",
    spaces: "Пространства",
    spaces_description: "Создавайте отдельные рабочие пространства с собственными обоями, темами, задачами и заметками",
    ...
    spaces_delete_confirm: "Удалить это пространство? Все его настройки, задачи и заметки будут удалены навсегда.",
    ...
    spaces_time_sensitive_description: "Автоматически переключать пространства в зависимости от времени суток",
    spaces_time_range: "Активное время",
    spaces_time_overlap_error: "Временные диапазоны не могут пересекаться с другими пространствами",
  ...
  es: {
    ...
    center_widgets_away_from_dock: "Desplazar los widgets centrales lejos del Dock",
    ...
    export_data_description: "Descarga una copia de seguridad de tus ajustes, tareas y notas adhesivas.",
    export_to_json: "Exportar a JSON",
    import_data_title: "Importar datos",
    import_data_description: "Restaura tus datos desde un archivo de copia de seguridad. Esto sobrescribirá los datos actuales.",
    import_from_json: "Importar desde JSON",
    importing: "Importando...",
    import_confirm: "¿Seguro que quieres importar los datos? Esto sobrescribirá tus ajustes, tareas y notas actuales. Esta acción no se puede deshacer.",
    import_failed: "Error al importar los datos. Comprueba el formato del archivo.",
    ...
    enable_sticky_notes_sync_description: "Sincroniza las notas adhesivas entre dispositivos usando tu cuenta de Chrome",
    ...
    freeform_zoom_locked: "Zoom disponible en Pro",
    freeform_pro_only: "Solo Pro",
    freeform_pricing_notice: "✨ Freeform es gratuito por ahora — algunas funciones podrían volverse de pago en el futuro. ¡Apóyanos para ayudar a mantenerlo gratis para todos!",
    ...
    support_description: "Mac New Tab es gratis y siempre lo será. Si te gusta usarlo, ¡invitarme a un café es de gran ayuda para apoyar futuras actualizaciones y nuevas funciones!",
    spaces: "Espacios",
    spaces_description: "Cree espacios de trabajo separados con su propio fondo de pantalla, tema, tareas y notas",
    ...
    spaces_delete_confirm: "¿Eliminar este espacio? Toda su configuración, tareas y notas se eliminarán permanentemente.",
    spaces_cannot_delete_last: "No se puede eliminar el último espacio",
    spaces_time_sensitive: "Espacios sensibles al tiempo",
    spaces_time_sensitive_description: "Cambia automáticamente de espacio según la hora del día",
    spaces_time_range: "Tiempo Activo",
    spaces_time_overlap_error: "Los rangos de tiempo no pueden superponerse con otros espacios",
  ...
  ja: {
    ...
    freeform_pricing_notice: "✨ Freeform は今無料です — 将来一部の機能が有料になる可能性があります。無料を維持するためにサポートをお願いします！",
    ...
    support_description: "Mac New Tab はずっと無料でご利用いただけます。もし気に入っていただけたなら、コーヒー1杯分のご支援が、今後のアップデートや新機能開発の大きな支えになります！",
    spaces: "スペース",
    spaces_description: "専用の壁紙、テーマ、ToDo、メモを持つ個別のワークスペースを作成します",
    spaces_enable: "スペースを有効にする",
    spaces_add: "スペースを追加",
    spaces_name_placeholder: "スペース名",
    spaces_delete: "スペースを削除",
    spaces_delete_confirm: "このスペースを削除しますか？設定、ToDo、メモは完全に削除されます。",
    spaces_cannot_delete_last: "最後のスペースは削除できません",
    spaces_time_sensitive: "時間指定スペース",
    spaces_time_sensitive_description: "時間帯に基づいてスペースを自動的に切り替えます",
    spaces_time_range: "アクティブな時間",
    spaces_time_overlap_error: "時間範囲を他のスペースと重複させることはできません",
  ...
  ko: {
    ...
    freeform_pricing_notice: "✨ Freeform은 현재 무료입니다 — 향후 일부 기능이 유료로 전환될 수 있습니다. 무료 유지를 위해 지원해 주세요!",
    ...
    support_description: "Mac 신규 탭은 항상 무료로 제공됩니다. 유용하게 사용하고 계신다면, 작은 커피 한 잔의 후원이 향후 업데이트와 새로운 기능 개발에 큰 힘이 됩니다!",
    spaces: "스페이스",
    spaces_description: "고유한 배경화면, 테마, 할 일 및 메모가 있는 별도의 작업 공간을 만드세요",
    spaces_enable: "스페이스 활성화",
    spaces_add: "스페이스 추가",
    spaces_name_placeholder: "스페이스 이름",
    spaces_delete: "스페이스 삭제",
    spaces_delete_confirm: "이 스페이스를 삭제하시겠습니까? 모든 설정, 할 일 및 메모가 영구적으로 제거됩니다.",
    spaces_cannot_delete_last: "마지막 스페이스는 삭제할 수 없습니다",
    spaces_time_sensitive: "시간 지정 스페이스",
    spaces_time_sensitive_description: "하루의 시간에 따라 스페이스를 자동으로 전환합니다",
  ...
  id: {
    ...
    freeform_pricing_notice: "✨ Freeform saat ini gratis — beberapa fitur mungkin berbayar di masa depan. Dukung kami agar tetap gratis!",
    ...
    support_description: "Mac New Tab gratis dan akan selalu begitu. Jika Anda menyukainya, traktir secangkir kopi akan sangat membantu dalam mendukung pembaruan dan fitur baru di masa mendatang!",
    spaces: "Ruang",
    spaces_description: "Buat ruang kerja terpisah dengan wallpaper, tema, daftar tugas, dan catatannya sendiri",
    spaces_enable: "Aktifkan Ruang",
    spaces_add: "Tambah Ruang",
    spaces_name_placeholder: "Nama ruang",
    spaces_delete: "Hapus Ruang",
    spaces_delete_confirm: "Hapus ruang ini? Semua pengaturan, daftar tugas, dan catatannya akan dihapus secara permanen.",
    spaces_cannot_delete_last: "Tidak dapat menghapus ruang terakhir",
    spaces_time_sensitive: "Ruang Sensitif Waktu",
    spaces_time_sensitive_description: "Beralih ruang secara otomatis berdasarkan waktu",
    spaces_time_range: "Waktu Aktif",
    spaces_time_overlap_error: "Rentang waktu tidak boleh tumpang tindih dengan ruang lain",
  ...
  mr: {
    ...
    freeform_pricing_notice: "✨ Freeform आता मोफत आहे — भविष्यात काही वैशिष्ट्ये सशुल्क होऊ शकतात. मोफत ठेवण्यास मदत करा!",
    ...
    support_description: "मॅक न्यू टॅब विनामूल्य आहे आणि नेहमीच असेल. जर तुम्हाला हे आवडले असेल, तर एक छोटी कॉफी भेट दिल्यास भविष्यातील अपडेट्स आणि नवीन फीचर्स विकसित करण्यास खूप मदत होईल!",
    spaces: "स्पेसेस",
    spaces_description: "स्वतःचे वॉलपेपर, थीम, टोडो आणि नोट्ससह स्वतंत्र कार्यक्षेत्रे तयार करा",
    spaces_enable: "स्पेसेस सक्षम करा",
    spaces_add: "स्पेस जोडा",
    spaces_name_placeholder: "स्पेसचे नाव",
    spaces_delete: "स्पेस हटवा",
    spaces_delete_confirm: "ही स्पेस हटवायची का? त्याची सर्व सेटिंग्ज, टोडो आणि नोट्स कायमस्वरूपी काढून टाकल्या जातील.",
    spaces_cannot_delete_last: "शेवटची स्पेस हटवता येत नाही",
    spaces_time_sensitive: "वेळ-संवेदनशील स्पेसेस",
    spaces_time_sensitive_description: "दिवसाच्या वेळेनुसार स्वयंचलितपणे स्पेसेस स्विच करा",
  ...
  pl: {
    ...
    export_data_description: "Pobierz kopię zapasową swoich ustawień, zadań i notatek.",
    export_to_json: "Eksportuj do JSON",
    import_data_title: "Importuj dane",
    import_data_description: "Przywróć dane z pliku kopii zapasowej. Spowoduje to nadpisanie obecnych danych.",
    import_from_json: "Importuj z JSON",
    importing: "Importowanie...",
    import_confirm: "Czy na pewno chcesz zaimportować dane? Spowoduje to nadpisanie bieżących ustawień, zadań i notatek. Tej czynności nie można cofnąć.",
    ...
    quick_links_default_description: "Pokazuje najczęściej odwiedzane witryny w przeglądarce",
    quick_links_custom_description: "Pokaż własne niestandardowe linki",
    enable_sticky_notes_sync: "Synchronizuj notatki",
    enable_sticky_notes_sync_description: "Synchronizuj notatki na różnych urządzeniach za pomocą konta Chrome",
    ...
    freeform_pricing_notice: "✨ Freeform jest teraz bezpłatny — niektóre funkcje mogą zostać płatne. Pomóż nam utrzymać go za darmo!",
    ...
    support_description: "Mac New Tab jest darmowy i zawsze taki będzie. Jeśli lubisz z niego korzystać, postawienie mi małej kawy bardzo pomoże w pracy nad przyszłymi aktualizacjami i nowymi funkcjami!",
    spaces: "Przestrzenie",
    spaces_description: "Twórz oddzielne przestrzenie robocze z własną tapetą, motywem, zadaniami i notatkami",
    ...
    spaces_delete_confirm: "Usunąć tę przestrzeń? Wszystkie jej ustawienia, zadania i notatki zostaną trwale usunięte.",
    spaces_cannot_delete_last: "Nie można usunąć ostatniej przestrzeni",
    spaces_time_sensitive: "Przestrzenie zależne od czasu",
    spaces_time_sensitive_description: "Automatycznie przełączaj przestrzenie w zależności od pory dnia",
    spaces_time_range: "Czas aktywności",
    spaces_time_overlap_error: "Zakresy czasowe nie mogą się pokrywać z innymi przestrzeniami",
  ...
  de: {
    ...
    voice_search_warning: "Die Sprachsuche wird für diese Sprache nicht unterstützt.",
    ...
    export_data_description: "Laden Sie ein Backup Ihrer Einstellungen, Todos und Haftnotizen herunter.",
    export_to_json: "Als JSON exportieren",
    import_data_title: "Daten importieren",
    import_data_description: "Stellen Sie Ihre Daten aus einer Sicherungsdatei wieder her. Dies überschreibt aktuelle Daten.",
    import_from_json: "Aus JSON importieren",
    importing: "Wird importiert...",
    import_confirm: "Möchten Sie die Daten wirklich importieren? Dies überschreibt Ihre aktuellen Einstellungen, Todos und Notizen. Diese Aktion kann nicht rückgängig gemacht werden.",
    import_failed: "Fehler beim Importieren der Daten. Bitte prüfen Sie das Dateiformat.",
    ...
    quick_links_default_description: "Zeigt die meistbesuchten Seiten Ihres Browsers",
    quick_links_custom_description: "Zeigen Sie Ihre eigenen Links an",
    enable_sticky_notes_sync: "Haftnotizen synchronisieren",
    enable_sticky_notes_sync_description: "Synchronisieren Sie Haftnotizen über Geräte hinweg mit Ihrem Chrome-Konto",
    ...
    freeform_pricing_notice: "✨ Freeform ist derzeit kostenlos — einige Funktionen könnten zukünftig kostenpflichtig werden. Unterstütze uns, damit es kostenlos bleibt!",
    ...
    support_description: "Mac New Tab ist kostenlos und wird es immer bleiben. Wenn es Ihnen gefällt, hilft eine kleine Kaffee-Spende enorm dabei, zukünftige Updates und neue Funktionen zu unterstützen!",
    spaces: "Bereiche",
    spaces_description: "Erstellen Sie separate Arbeitsbereiche mit eigenem Hintergrund, Thema, Aufgaben und Notizen",
    ...
    spaces_delete_confirm: "Diesen Bereich löschen? Alle Einstellungen, Aufgaben und Notizen werden dauerhaft entfernt.",
    spaces_cannot_delete_last: "Der letzte Bereich kann nicht gelöscht werden",
    spaces_time_sensitive: "Zeitgesteuerte Bereiche",
    spaces_time_sensitive_description: "Bereiche automatisch basierend auf der Tageszeit wechseln",
    spaces_time_range: "Aktivitätszeit",
    spaces_time_overlap_error: "Zeiträume dürfen sich nicht mit anderen Bereichen überschneiden",
