...
import { WALLPAPER_BLUR_LOCAL_STORAGE_KEY, WALLPAPER_FIT_LOCAL_STORAGE_KEY } from "./wallpapers";
import {
...
export const PER_SPACE_KEYS: string[] = [
  ...
  WALLPAPER_FIT_LOCAL_STORAGE_KEY, // "wallpaper_fit"
  ...
  SHOW_SEARCH_BAR_LOCAL_STORAGE_KEY, // "show_search_bar"
  ...
  SHOW_SCREEN_RECORDER_LOCAL_STORAGE_KEY, // "show_screen_recorder"
